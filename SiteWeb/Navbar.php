...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card">
        ...
        <a href="home.php" class="w3-bar-item w3-button w3-padding-large">Accueil</a>
        <?php
        //Si lutilisateur est connecte, on lui donne un lien pour modifier ses informations, pour voir ses messages et un pour se deconnecter
        if(isset($_SESSION['email']))
        {
            ?>
            <a href="profile.php?id=<?php echo $dnn['email']; ?>" class="w3-padding-large w3-hover-red w3-hide-small w3-right"><?php if(isset($_SESSION['email'])){echo ' '.htmlentities($_SESSION['email'], ENT_QUOTES, 'UTF-8');} ?></a>
            <div class="w3-dropdown-hover w3-hide-small w3-right">
                <button class="w3-padding-large w3-button" ><i class="fa fa-caret-down"></i></button>
                    <div class="w3-dropdown-content w3-bar-block w3-card-4">
                        ...
                        <a href="connexion.php" class="w3-bar-item w3-button">Déconnexion</a>
                    </div>
            </div>
            <?php
        }
        ...
        //Sinon, on lui donne un lien pour sinscrire et un autre pour se connecter
            ...
            <a href="connexion.php" class="w3-bar-item w3-button w3-padding-large ">Connexion</a>
            <?php
        }
        ?>
